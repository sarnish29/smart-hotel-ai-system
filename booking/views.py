...
def panel(request):
    ...
    response = render(request,'staff/panel.html',{'location':hotel,'reserved':reserved,'rooms':rooms,'total_rooms':total_rooms,'available':available_rooms,'unavailable':unavailable_rooms,'bookings': bookings})
    return HttpResponse(response)
...
def directions(request):
    if request.user.is_authenticated:
        return HttpResponse(render(request, 'directions.html'))
